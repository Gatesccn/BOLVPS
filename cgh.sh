...
# Moded editado por @el mandarin sniff
...
source <(curl -sL https://raw.githubusercontent.com/Gatesccn/GatesccnScripts/main/msg) > /dev/null
fun_ip () {
...
msg -bar3
echo -e ""
echo -e "${cor[2]}\n\033[1;37m  Script Patrocinado por: @GATESCCN - EL MANDARIN SNIFF" | pv -qL 12
echo -e ""
msg -bar3
echo -ne "${cor[4]}"
